...
- 博客添加Home、Archives同级菜单导航：
	...
	<img src="/imgs/article/add_navigation_01.png" alt="directory">
	...
	<br><img src="/imgs/article/add_navigation_02.png" alt="navigation">
	<br><img src="/imgs/article/add_navigation_03.png" alt="navigation">

- 针对博客过长，显示主要内容在主页，点击"更多"显示全文
	
	- 在博客简介完成之后添加 ` <!--more-->` 即可<br><img src="/imgs/article/read_more.png" alt="Read More">